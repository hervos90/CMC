                ...
                <div className="data-scrollbar" data-scroll="1" id="sidebar-scrollbar">
                    ...
                    <Accordion as="ul" id="iq-sidebar-toggle" className="iq-menu" onSelect={(e) => setActiveMenu(e)}>
                        ...
                        <li className={activeMenu === '1' ? 'active' : ''}>
                            <Accordion.Toggle as={Button} href="#" eventKey="1" variant=" collapsed" data-toggle="collapse" aria-expanded="false"><i className="las la-film"></i><span>Média</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                            <Accordion.Collapse className="submenu" eventKey="1">
                                <ul id="media" className="iq-submenu" data-parent="#iq-sidebar-toggle">
                                        <li className={`${location.pathname === '/dashboard/add-media' ? 'active' : ''} `}><Link to="/dashboard/add-media"><i class="las la-plus"></i>Nouveau Media</Link></li>
                                        <li className={`${location.pathname === '/dashboard/media-list' ? 'active' : ''} `}><Link to="/dashboard/media-list"><i className="las la-eye"></i>Liste media</Link></li>
                                </ul>
                            </Accordion.Collapse>
                        </li>
                        ...
                        <li className={activeMenu === '2' ? 'active' : ''}>
                                <Accordion.Toggle as={Button} href="#" eventKey="2" variant=" collapsed" data-toggle="collapse" aria-expanded={activeMenu === '0' ? 'true' : 'false'}><i class="las la-user-friends"></i><span>Orateurs</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                            <Accordion.Collapse className="submenu" eventKey="2">
                                <ul id="orateur" className="iq-submenu " data-parent="#iq-sidebar-toggle">
                                        <li className={`${location.pathname === '/dashboard/add-orateur' ? 'active' : ''} `}><Link to="/dashboard/add-orateur"><i className="las la-user-plus"></i>Nouvel orateur</Link></li>
                                        <li className={`${location.pathname === '/dashboard/orateur-list' ? 'active' : ''} `}><Link to="/dashboard/orateur-list"><i className="las la-eye"></i>Liste orateurs</Link></li>
                                </ul>
                            </Accordion.Collapse>
                        </li>
                        ...
                        <li className={activeMenu === '3' ? 'active' : ''}>
                            <Accordion.Toggle as={Button} href="#" eventKey="3" variant=" collapsed" data-toggle="collapse" aria-expanded={activeMenu === '0' ? 'true' : 'false'}><i class="las la-users"></i><span>Acteurs</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                            <Accordion.Collapse className="submenu" eventKey="3">
                                <ul id="acteur" className="iq-submenu " data-parent="#iq-sidebar-toggle">
                                    <li className={`${location.pathname === '/add-acteur' ? 'active' : ''} `}><Link to="/dashboard/add-acteur"><i className="las la-user-plus"></i>Add Acteur</Link></li>
                                    <li className={`${location.pathname === '/acteur-list' ? 'active' : ''} `}><Link to="/dashboard/acteur-list"><i className="las la-eye"></i>Acteur List</Link></li>
                                </ul>
                            </Accordion.Collapse>
                        </li>
                            ...
                            <li className={activeMenu === '4' ? 'active' : ''}>
                                <Accordion.Toggle as={Button} href="#" eventKey="4" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '3' ? 'true' : 'false'}><i class="las la-users-cog"></i><span>Paramètres Utilisateurs</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                <Accordion.Collapse className="submenu" eventKey="4">
                                    <Accordion as="ul" id="ui-elements" className="iq-submenu" data-parent="#iq-sidebar-toggle" onSelect={(e) => setSubmenu(e)}>
                                        ...
                                        <li className={`${location.pathname === '/list-users' ? 'active' : ''} `}>
                                            <Link to="/list-users" className="iq-waves-effect">
                                        ...
                                        {/*---------gestion des roles--------*/}
                                        <li className={`${location.pathname === '/list-role' || location.pathname === '/add-role'? 'active' : ''}`}>
                                            <Accordion.Toggle as={Button} eventKey="1" href="#" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '0' ? 'true' : 'false'}><i class="las la-id-card"></i><span>Roles</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                            <Accordion.Collapse className="submenu" eventKey="1">
                                                <ul id="tables" className="iq-submenu" data-parent="#ui-elements">
                                                    <li className={`${location.pathname === '/list-role' ? 'active' : ''} `}><Link to="/list-role"><i class="las la-plus"></i>Nouveau role</Link></li>
                                                    <li className={`${location.pathname === '/add-role' ? 'active' : ''} `}><Link to="/add-role"><i className="las la-eye"></i>Liste roles</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>
                                        ...
                                        <li className={`${location.pathname === '/list-permission' || location.pathname === '/add-permission' || location.pathname === '/table-editable' ? 'active' : ''}`}>
                                            <Accordion.Toggle as={Button} eventKey="2" href="#" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '3' ? 'true' : 'false'}><i class="las la-key"></i><span>Permissions</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                            <Accordion.Collapse className="submenu" eventKey="2">
                                                <ul id="tables" className="iq-submenu" data-parent="#ui-elements">
                                                    <li className={`${location.pathname === '/add-permission' ? 'active' : ''} `}><Link to="/add-permission"><i class="las la-plus"></i>Nouvelle permissions</Link></li>
                                                    <li className={`${location.pathname === '/list-permission' ? 'active' : ''} `}><Link to="/list-permission"><i className="las la-eye"></i>Liste permissions</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>
                                    </Accordion>
                            ...
                            <li className={activeMenu === '3' ? 'active' : ''}>
                                <Accordion.Toggle as={Button} href="#" eventKey="5" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '3' ? 'true' : 'false'}><i class="las la-cogs"></i><span>Paramètres</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                <Accordion.Collapse className="submenu" eventKey="5">
                                    <Accordion as="ul" id="ui-elements" className="iq-submenu" data-parent="#iq-sidebar-toggle" onSelect={(e) => setSubmenu(e)}>

                                        {/*---------gestion des églises-----*/}
                                        <li className={`elements  ${location.pathname === '/dashboard/add-eglise' || location.pathname === '/dashboard/eglise-list"' ? 'active' : ''}`}>
                                            <Accordion.Toggle as={Button} eventKey="0" href="#" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '0' ? 'true' : 'false'}><i class="las la-place-of-worship"></i><span>Eglise</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                            <Accordion.Collapse className="submenu" eventKey="0">
                                                <ul id="sub-menu" className="iq-submenu" data-parent="#ui-elements">
                                                    <li className={`${location.pathname === '/dashboard/add-eglise' ? 'active' : ''} `}><Link to="/dashboard/add-eglise"><i class="las la-plus"></i>Nouvelle église</Link></li>
                                                    <li className={`${location.pathname === '/dashboard/eglise-list"' ? 'active' : ''} `}><Link to="/dashboard/eglise-list"><i className="las la-eye"></i>Liste église</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>

                                        {/*---------gestion des type des media-----*/}
                                        <li className={`form ${location.pathname === '/dashboard/add-type-media' || location.pathname === '/dashboard/type-media-list' ? 'active' : ''} `}>
                                            <Accordion.Toggle as={Button} eventKey="1" href="#" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '1' ? 'true' : 'false'}><i class="las la-file-video"></i><span>Type de media</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                            <Accordion.Collapse className="submenu" eventKey="1">
                                                <ul id="forms" className="iq-submenu" data-parent="#ui-elements">
                                                    <li className={`${location.pathname === '/dashboard/add-type-media' ? 'active' : ''} `}><Link to="/dashboard/add-type-media"><i class="las la-plus"></i>Nouveau type média</Link></li>
                                                    <li className={`${location.pathname === '/dashboard/type-media-list' ? 'active' : ''} `}><Link to="/dashboard/type-media-list"><i className="las la-eye"></i>Liste type média</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>

                                        {/*------gestion des catégories-----*/}
                                        <li className={`${location.pathname === '/dashboard/add-category' || location.pathname === '/dashboard/list-category' ? 'active' : ''}`}>
                                            <Accordion.Toggle as={Button} eventKey="2" href="#" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '3' ? 'true' : 'false'}><i class="las la-sitemap"></i><span>Catégorie</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                            <Accordion.Collapse className="submenu" eventKey="2">
                                                <ul id="tables" className="iq-submenu" data-parent="#ui-elements">
                                                    <li className={`${location.pathname === '/dashboard/add-category' ? 'active' : ''} `}><Link to="/dashboard/add-category"><i class="las la-plus"></i>Nouvelle catégorie</Link></li>
                                                    <li className={`${location.pathname === '/dashboard/category-list' ? 'active' : ''} `}><Link to="/dashboard/category-list"><i className="las la-eye"></i>Liste catégorie</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>
                                        ...
                                        {/*---------gestion des langues--------*/}
                                        <li className={`${location.pathname === '/dashboard/add-langue' || location.pathname === '/dashboard/langue-list' ? 'active' : ''}`}>
                                            <Accordion.Toggle as={Button} eventKey="3" href="#" variant=" collapsed" data-toggle="collapse" aria-expanded={activesubMenu === '3' ? 'true' : 'false'}><i class="las la-language"></i><span>Langue</span><i className="ri-arrow-right-s-line iq-arrow-right"></i></Accordion.Toggle>
                                            <Accordion.Collapse className="submenu" eventKey="3">
                                                <ul id="tables" className="iq-submenu" data-parent="#ui-elements">
                                                    <li className={`${location.pathname === '/dashboard/add-langue' ? 'active' : ''} `}><Link to="/dashboard/add-langue"><i class="las la-plus"></i>Nouvelle langue</Link></li>
                                                    <li className={`${location.pathname === '/dashboard/langue-list' ? 'active' : ''} `}><Link to="/dashboard/langue-list"><i className="las la-eye"></i>Liste langue</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>
                                    </Accordion>
                        ...
                        <li className={activeMenu === '1' ? 'active' : ''}>
                            ...
                            <ul id="movie" className="iq-submenu" data-parent="#iq-sidebar-toggle">
                                <li className={`${location.pathname === '/add-movie' ? 'active' : ''} `}><Link to="/dashboard/add-movie"><i className="las la-user-plus"></i>Add Movie</Link></li>
                                <li className={`${location.pathname === '/movie-list' ? 'active' : ''} `}><Link to="/dashboard/movie-list"><i className="las la-eye"></i>Movie List</Link></li>
                            </ul>
                            </Accordion.Collapse>
                        </li>
                        <li className={activeMenu === '2' ? 'active' : ''}>
