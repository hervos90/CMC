...
const SignUp = (props) => {
    ...
    const handleRegister = async () => {
        ...
        // Stockez le jeton JWT dans le stockage local ou les cookies après l'enregistrement réussi
                                ...
                                <div className="sign-in-page-data">
                                    <div className="sign-in-from w-100 m-auto">
                                        <Form>
                                            <Row>
                                                <Col md="6">
                                                    <Form.Group>
                                                        ...
                                                        <Form.Control onChange={(e) => setUserName(e.target.value)} type="text" className="form-control mb-0" id="exampleInputEmail2" placeholder="Enter Full Name" autoComplete="off" required/>
                                                    </Form.Group>
                                                </Col>
                                                <Col md="6">
                                                    <Form.Group>  
                                                        <Form.Label>E-mail</Form.Label>                               
                                                        <Form.Control onChange={(e) => setEmail(e.target.value)} type="email" className="mb-0" id="exampleInputEmail3" placeholder="Enter email" autoComplete="off" required/>
                                                    </Form.Group>
                                                </Col>
                                                <Col md="6">
                                                    <Form.Group>
                                                ...
                                                <Col md="6">
                                                    <Form.Group>   
                                                        ...
                                                        <Form.Control onChange={(e) => setPassword(e.target.value)} type="password" className="mb-0" id="exampleInputPassword2" placeholder="Password" required/>
                                                    </Form.Group>
                                                </Col>
                                                <Col md="6">
                                                    <Form.Group> 
                                            ...
                                            <Button onClick={handleRegister} className="btn btn-hover btn-primary1 my-2">Sign Up</Button>                              
                                        </Form>
                                    </div>
                                </div>    
                                <div className="mt-3">
                                    <div className="d-flex justify-content-center links">
                                        ...
                                        <Link to="/extra-pages/login" className="text-primary ml-2">Sign In</Link>
                                    </div>                        
                                </div>
                            </div>
                        </Col>
