...
const TypeMediaList = (props) => {
    ...
    const listTypeMedias = typeMedias.map((typeMedia) => (
        <tr key={typeMedia.typeMediaId}>
            <td>  </td>
            <td> {typeMedia.libelle} </td>
            <td>
                <div className="flex align-items-center list-user-action">
                    ...
                    <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
                        <Link className="iq-bg-success" to={{ pathname: '/dashboard/edit-typeMedia', state: typeMedia.typeMediaId }}><i className="ri-pencil-line"></i></Link>
                    </OverlayTrigger>
                    ...
                    <Col sm="12">
                        <Card>
                            <Card.Header className="d-flex justify-content-between">
                                <Card.Header.Title>
                                    <h4 className="card-title">Liste des TypeMedias</h4>
                                </Card.Header.Title>
                                <div className="iq-card-header-toolbar d-flex align-items-center">
                                    <Link to="/dashboard/add-type-media" className="btn btn-primary">Nouvel Type media</Link>
                                </div>
                            </Card.Header>
                            <Card.Body>
